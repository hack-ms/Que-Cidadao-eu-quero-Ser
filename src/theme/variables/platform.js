...
export default {
  ...
  // Button
  buttonFontFamily: platform === PLATFORM.IOS ? 'Quicksand' : 'Quicksand',
  ...
  contentMarginHorizontal: scale(10),
  contentMarginVertical: verticalScale(10),
};
